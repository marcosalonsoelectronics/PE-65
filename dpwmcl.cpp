// Automatically generated C++ file on Fri Apr 26 12:20:46 2024
//
...
extern "C" __declspec(dllexport) void dpwmcl(void **opaque, double t, union uData *data)
{
   ...
   double  Tsp      = data[2].d; // input parameter
   double &PWM      = data[3].d; // output
   double &Sawtooth = data[4].d; // output
   double &Vos      = data[5].d; // output
   double &Ds       = data[6].d; // output
   double &Port1    = data[7].d; // output
